...
const EnhancedNotificationsScreen: React.FC = () => {
  const mockNotifications = [
    {
      ...
      user: {
        ...
        avatar:
          "https://images.unsplash.com/photo-1621523379646-ec4d96325720?w=40",
      },
    ...
    },
    {
      ...
      user: {
        username: "alex_photo",
        avatar:
          "https://images.unsplash.com/photo-1621523379646-ec4d96325720?w=50",
      },
    ...
    },
    {
      ...
      user: {
        username: "john_doe",
        avatar:
          "https://images.unsplash.com/photo-1621523379646-ec4d96325720?w=60",
      },
  ...
  return (
    <motion.div
      ...
      className="w-full pb-20 md:pb-8 md:ml-64"
    >
      <div className="max-w-2xl mx-auto pt-20 md:pt-4">
        <div className="p-4 border-b bg-background/80 backdrop-blur-lg sticky top-16 md:top-0 z-10">
          <h1 className="text-foreground">Activity</h1>
          <p className="text-sm text-muted-foreground">
            See what's happening with your posts
          </p>
        </div>
        ...
        <div className="p-4 space-y-6">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <div className="w-full h-20 bg-gray-900 rounded-lg border border-border mb-3"></div>
            ...
            <div className="space-y-1">
              {[
                ...
                <motion.button
                  key={item}
                  whileHover={{ x: 4 }}
                  className="w-full text-left p-3 rounded-xl hover:bg-muted transition-colors text-foreground"
                >
                  {item}
                </motion.button>
              ))}
...
const SavedPostsScreen: React.FC = () => {
  return (
    ...
    >
      <div className="max-w-2xl mx-auto pt-20 md:pt-4">
        <div className="p-4 border-b bg-background/80 backdrop-blur-lg sticky top-16 md:top-0 z-10">
          <h1 className="text-foreground">Saved Posts</h1>
          <p className="text-sm text-muted-foreground">
        ...
        <div className="p-4 text-center">
          <div className="max-w-sm mx-auto">
            ...
            <p className="text-sm text-muted-foreground">
              Bookmark posts to easily find them again. Only you
